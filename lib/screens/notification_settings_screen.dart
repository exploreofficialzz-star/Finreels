...
/// Notification preferences — toggle alerts on/off and request OS permission.
///
/// Reached via the gear icon inside [NotificationsScreen].  Keeping settings
/// separate from the inbox gives a clean Facebook-style UX: the inbox is the
/// primary destination, settings are a secondary action.
...
class _NotificationSettingsScreenState
  ...
  Future<void> _toggle(bool value) async {
    ...
    if (value && mounted) await _requestPermission();
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'FinReels needs notification permission to alert you about new '
            'videos. Tap below to grant it — you only need to do this once.',
            style: Theme.of(context).textTheme.bodySmall?.copyWith(
                  color: AppTheme.textSecondary(context),
                ),
          ),
